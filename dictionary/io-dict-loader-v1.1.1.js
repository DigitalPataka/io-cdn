/*! io-dict-loader v1.1.1 — Session 50 (stopwords restored + extended)
 ...
 *
 *  v1.1.1: dictionary data carries the original 32 stopwords from v1.0.0
 *  CORE (a regression in v1.1.0 dropped them) plus 7 extension stopwords
 *  (if, as, than, but, yet, so, there). Projection now filters stopwords
 *  out so they never become role entries. Otherwise identical to v1.1.0.
 */
(function(){
  'use strict';
