/*! io-dict-loader v1.1.2 — Session 50 (multi-word phrase keys restored)
 ...
 *
 *  v1.1.2: dictionary projection now ALSO emits multi-word phrase keys
 *  (in addition to per-word entries) for category names, qualifier names,
 *  and option values. Restores phrase recognition for "bay of plenty",
 *  "trade me motors", "real estate" etc. that v1.1.0/v1.1.1 silently lost
 *  when carry-forward dropped tm-tagged phrase entries. Internal stopwords
 *  preserved in phrases; leading/trailing trimmed. Loader code unchanged
 *  from v1.1.1 — only the dict payload shape grew.
 */
(function(){
  'use strict';
