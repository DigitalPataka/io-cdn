  ...
  var tmPropertyModules = {
    "trademe-rental": {
      ...
      queryByName: function(query, opts) {
        ...
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Rent", "lowest rent": "Rent", "newest": "ListingDate", "latest": "ListingDate"};
    ...
    "trademe-property": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "newest": "ListingDate", "latest": "ListingDate", "most expensive": "PriceDesc"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    "trademe-cars": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "PriceAsc", "lowest price": "PriceAsc", "most expensive": "PriceDesc", "newest": "Latest", "latest": "Latest", "lowest km": "Odometer"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        params += "&rows=20";
    ...
    "trademe-jobs": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"highest pay": "PayDesc", "best paid": "PayDesc", "newest": "ListingDate", "latest": "ListingDate", "closing soon": "ExpiryAsc"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        params += "&rows=20";
    ...
    "trademe-categories": {
      ...
      category: "reference",
      description: "Full marketplace category hierarchy",
      ...
      parse: function(data) {
        ...
        return {
          name: data.Name,
          topLevel: data.Subcategories.map(function(cat) {
            return {
              name: cat.Name,
              number: cat.Number,
              path: cat.Path,
