  ...
  var modules = {
    ...
    poi: {
      ...
      query: function(lat, lng, opts) {
        ...
        // Build Overpass query — if qualifier matches, filter to that type only
        var filter = null;
        if (opts && opts.qualifier) {
          var translated = this.qualifierTranslations[opts.qualifier.toLowerCase()];
