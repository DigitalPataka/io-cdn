var IoCartridge_Trademe = (function() {
  ...
  // ══════════════════════════════════════════════════════════════
  // TRADE ME MARKETPLACE CARTRIDGE v1.13.2
  ...
  // path appears to be served from a CDN edge that doesn't mint
  // TM/Cloudflare session cookies. Same-origin (www.trademe.co.nz),
  // tiny payload (a few KB SVG). AbortController on the fetch so the
  // socket closes if TM stalls.
  var TM_WARM_URL = "https://www.trademe.co.nz/images/logo-2025/tm-logo-spotlight-2025.svg";
