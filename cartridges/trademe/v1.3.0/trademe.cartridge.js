var IoCartridge_Trademe = (function() {
  ...
  // ══════════════════════════════════════════════════════════════
  // TRADE ME MARKETPLACE CARTRIDGE v1.3.0
  ...
  // v1.3.0: trademe-lifestyle, trademe-rural, trademe-open-homes,
  ...
  var modules = {
    ...
    "trademe-commercial-sale": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "most expensive": "PriceDesc", "highest price": "PriceDesc", "newest": "ListingDate", "latest": "ListingDate", "just listed": "ListingDate"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    "trademe-commercial-lease": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Rent", "lowest rent": "Rent", "lowest price": "Rent", "most expensive": "RentDesc", "highest rent": "RentDesc", "newest": "ListingDate", "latest": "ListingDate", "just listed": "ListingDate"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    // ---- LIFESTYLE PROPERTY (Session 43, v1.3.0) ----
    "trademe-lifestyle": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "most expensive": "PriceDesc", "highest price": "PriceDesc", "newest": "ListingDate", "latest": "ListingDate", "just listed": "ListingDate", "biggest": "LandAreaDesc", "largest": "LandAreaDesc", "smallest": "LandArea"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    // ---- RURAL PROPERTY (Session 43, v1.3.0) ----
    "trademe-rural": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "most expensive": "PriceDesc", "highest price": "PriceDesc", "newest": "ListingDate", "latest": "ListingDate", "just listed": "ListingDate", "biggest": "LandAreaDesc", "largest": "LandAreaDesc"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    "trademe-open-homes": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "most expensive": "PriceDesc", "soonest": "OpenHomeDate", "next": "OpenHomeDate", "newest": "ListingDate"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    // ---- RETIREMENT VILLAGES (Session 43, v1.3.0) ----
    "trademe-retirement": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "Price", "lowest price": "Price", "most expensive": "PriceDesc", "highest price": "PriceDesc", "newest": "ListingDate", "latest": "ListingDate"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
    ...
    // ---- STORE SEARCH (Session 43, v1.3.0) ----
    "trademe-stores": {
      ...
      queryByName: function(query, opts) {
        ...
        var params = "search_string=" + encodeURIComponent(searchTerm);
        if (opts && opts.qualifier) {
          var sorts = {"cheapest": "PriceAsc", "lowest price": "PriceAsc", "most expensive": "PriceDesc", "newest": "ListingDateDesc", "just listed": "ListingDateDesc", "closing soon": "ExpiryAsc", "most bids": "BidsMost"};
          var s = sorts[opts.qualifier.toLowerCase()];
          if (s) params += "&sort_order=" + s;
        }
        var rows = 20;
