var IoCartridge_Trademe = (function() {
  ...
  var meta = {
    id: "trademe",
    label: "Trade Me",
    version: "1.14.1",  // S83-F10 v2: parses normalised questions[] from data.Questions which the bare /v1/Listings/{id}.json endpoint returns naturally — no query param needed. v1.14.0 added ?return_questions=true which was the wrong move: that param triggers an auth gate, while the bare endpoint includes Questions alongside ViewCount/BidderAndWatchers/Body. Powers Q heat stat, QW% ratio, Quiet heat (active) signal, AND a Q&A list rendered below the description in the listing detail panel.
    born: "Session 43",
